          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Character Image
                Image.asset(
                  'assets/images/selfexam1.png', // Replace with your asset image path
                  height: 120,
                ),
                const SizedBox(height: 16),
                ...
                // Subtitle
                const Text(
                  "Check area between clavicle, the center of the armpit, the lower edge of the breast, the lower edge of the sternum.",
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 16,
