                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) =>  EditPeriod()),
                          );
                        },
                        child: const Text(
                          "• Edit Period",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.calendar_today, color: Color.fromARGB(255, 255, 255, 255)),
            onPressed: () {
              // Add calendar action
            },
          ),
        ...
        child: Column(
          ...
          children: [
            ...
            const Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("Sun", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                Text("Mon", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                Text("Tue", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                Text("Wed", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                Text("Thu", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                Text("Fri", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                Text("Sat", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
              ],
            ),
            const SizedBox(height: 16),
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: isToday && day != 0 ? Colors.blue : Colors.transparent, // Highlight today's date
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8.0),
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const ReviewSymptoms()),
                          );
                        },
                        child: const Text(
                          "• Edit Self Exam",
...
class _CalendarState extends State<Calendar> {
  ...
  final Map<DateTime, String> _dateImages = {
    ...
    DateTime(2024, 12, 18): 'assets/images/selfexam3.png',
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              _navigateToPage(
                                _dateImages[DateTime(day.year, day.month, day.day)]!,
                              );
                            },
                            child: Image.asset(
                              _dateImages[DateTime(day.year, day.month, day.day)]!,
