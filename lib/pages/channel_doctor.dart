...
class _ChannelDoctorState extends State<ChannelDoctor> {
  ...
  final List<String> specialties = ['Oncologist', 'Cardiologist', 'Dermatologist'];
  final List<String> hospitals = ['Hemas Hospital - Wattala', 'Asiri Hospital', 'Nawaloka Hospital'];
  final List<String> dates = ['Any Date', 'Today', 'Tomorrow', 'Next Week'];
